            ...
            >
              ...
              <span className={`flex items-start ${secondaryTextClass()}`}>
                ...
                <Image
                  ...
                  alt=""
                  className={`-mt-5 ${
                    currentProgression === 0.825 ? "opacity-100" : "opacity-45"
                  }`}
                  priority={true}
                />
                <span
                  className={`text-4xl font-semibold ml-3 ${secondaryTextClass()}`}
                >
                  with drag
                </span>
              </span>
              ...
              <span className="flex items-start gap-3">
                <span
                  className={`text-4xl font-semibold ${secondaryTextClass()}`}
                >
                  and drop.{" "}
                </span>
                <span
                  className={`text-4xl font-semibold ${tertiaryTextClass()}`}
                >
                  Made for you.
                </span>
              </span>
