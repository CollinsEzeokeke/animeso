...
export default function SecondScrollOverlay() {
  ...
  return (
    <section 
      className="relative w-full min-h-[220vh] bg-violet-800 pointer-events-none z-[60]"
    >
     <div>adhfjaidfhasdbfasdjv jidnvpwdigjwvsudfh9wupbesuhwjsdahsdfjvasidfvjwasdyvb9ub</div>
    </section>
  );
}
 ...
 {/* Enhanced spacer to control when content appears */}
      {/* <div ref={spacerRef} className="min-h-[100vh] relative" /> */}
      {/* Red background container - this scrolls with the page */}
      // <div className="w-full relative top-0 left-0">
      //   <div className="w-full bg-red-500 min-h-[120vh] flex items-center justify-center text-white">
      //     Scrolling Content
      //   </div>
      // </div>
