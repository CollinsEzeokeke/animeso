...
export default function Hero() {
  ...
  const movingAnother = useTransform(
    ...
    [
      ...
      `-${IsWidth <= 1394 && IsHeight <= 697 ? "500%" : IsWidth <= 1600 && IsHeight <= 800 ? "500%" : "490%"}`, // this is the value at 0.099
      // "-695%", // this is the value at 0.107 
      `-${IsWidth <= 1394 && IsHeight <= 697 ? "695%" : IsWidth <= 1600 && IsHeight <= 800 ? "680%" : "680%"}`, // this is the value at 0.107
      // "-680%", // this is the value at 0.107
      // "-885%", // this is the value at 0.115
      `-${IsWidth <= 1394 && IsHeight <= 697 ? "885%" : IsWidth <= 1600 && IsHeight <= 800 ? "850%" : "870%"}`, // this is the value at 0.115
      // "-850%", // this is the value at 0.115
      // "-1070%", // this is the value at 0.123
      `-${IsWidth <= 1394 && IsHeight <= 697 ? "1070%" : IsWidth <= 1600 && IsHeight <= 800 ? "1020%" : "1040%"}`, // this is the value at 0.123
      // "-1020%", // this is the value at 0.123
      // "-1260%", //this is the value at 0.131
      `-${IsWidth <= 1394 && IsHeight <= 697 ? "1260%" : IsWidth <= 1600 && IsHeight <= 800 ? "1190%" : "1235%"}`, //this is the value at 0.131
      // "-1190%", //this is the value at 0.131
      // "-1440%", // this is the value at 0.139
      `-${IsWidth <= 1394 && IsHeight <= 697 ? "1440%" : IsWidth <= 1600 && IsHeight <= 800 ? "1370%" : "1420%"}`, // this is the value at 0.139
      // "-1370%", // this is the value at 0.139
      // "-1620%", // this is the value at 0.147
      `-${IsWidth <= 1394 && IsHeight <= 697 ? "1620%" : IsWidth <= 1600 && IsHeight <= 800 ? "1550%" : "1615%"}`, // this is the value at 0.147
      // "-1550%", // this is the value at 0.147
      // "-1820%", // this is the Value at 0.155
      `-${IsWidth <= 1394 && IsHeight <= 697 ? "1820%" : IsWidth <= 1600 && IsHeight <= 800 ? "1750%" : "1810%"}`, // this is the Value at 0.155
  ...
  //     // "-885%", // this is the value at 0.115
  //     "-1040%", // this is the value at 0.123
  //     // "-1070%", // this is the value at 0.123
  //     "-1235%", //this is the value at 0.131
  //     // "-1260%", //this is the value at 0.131
  //     "-1420%", // this is the value at 0.139
  //     // "-1440%", // this is the value at 0.139
  //     "-1615%", // this is the value at 0.147
  //     // "-1620%", // this is the value at 0.147
  //     "-1810%", // this is the Value at 0.155
  //     // "-1820%", // this is the Value at 0.155
  //     "-2280%", // this is the value at 0.17
  //   ]
  // );
