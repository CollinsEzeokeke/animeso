...
export default function ActionButtons() {
  ...
  return (
    <motion.div
      className="fixed bottom-0 left-0 z-[100] right-0 flex items-center justify-center space-x-4 py-6 bg-gradient-to-t from-black/30 to-transparent backdrop-blur-sm "
