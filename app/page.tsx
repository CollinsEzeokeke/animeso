...
export default function Page() {
  ...
  return (
    <Geiger renderTimeThreshold={0.5}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                  <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <p className="text-gray-600">
                      Organize projects with AI-powered priority suggestions and
                  ...
                  <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <p className="text-gray-600">
                      View and manage all your commitments in one place with
                  ...
                  <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <p className="text-gray-600">
                      Prioritize communications with smart filtering and
                  ...
                  <div className="md:w-1/2">
                    ...
                    <ul className="space-y-4 mb-8">
                      ...
                      <li className="flex items-start">
                        ...
                        <p className="ml-3 text-gray-700">
                          Time-blocking tools to schedule dedicated work
                          sessions
                        </p>
                      </li>
                      <li className="flex items-start">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                <div className="bg-gray-800 p-8 rounded-xl">
                  ...
                  <p className="text-gray-300">
                    &quot;This tool has completely transformed how I organize my
                    day. The seamless integration between todos and calendar is
                ...
                <div className="bg-gray-800 p-8 rounded-xl">
                  ...
                  <p className="text-gray-300">
                    &quot;The email integration is stellar. I love how it
                    automatically suggests tasks based on my communications and
                ...
                <div className="bg-gray-800 p-8 rounded-xl">
                  ...
                  <p className="text-gray-300">
                    &quot;Since adopting this platform, my team&apos;s
                    productivity has increased by 35%. The collaboration
                    features are unmatched in any other tool we&apos;ve
                    tried.&quot;
                  </p>
                  <div className="mt-4 flex text-yellow-400">
                    <svg
